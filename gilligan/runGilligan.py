...
# os.system('export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/DPA/wookie/dpa/projects/eclipse/share/gilligan/3rdparty/3rdbuild/lib/')
...
ASSPATH = "../testAss/"
ASSNANE = "hand02_tri"
PRODNAME = "hand02_tri_v03"
OCEANMESHPATH = "../products/oceanmesh"
# -------------------------------------------------------


def CreateWaterSims(name):
...
simscene = CreateWaterSims('scene3')
...
# --------------------------------------------------
        ...
        # write_obj(filename)
        # obj_filename = os.path.join(OCEANMESHPATH, 'ocean_{name}.{frame}.obj'.format(name=PRODNAME, frame=util.formattedFrame(f)))
...
###### RENDER THE SCENE ############
        ...
        image_name = "../products/images/{name}_FPS{fps}.exr".format(name=PRODNAME, fps=str(int(thirsty.FPS)))
